(function ()
{
    ...
    function ToolbarController($location, $rootScope, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService, $mdDialog, AuthService, api, $http)
    {
        var vm = this;
		...
		vm.openModalPortal = openModalPortal;
		vm.openModalProperty = openModalProperty;
		vm.updateProfileModal = updateProfileModal;

		//////////


		function openModalPortal(type) {
			$mdDialog.show({
				controller         : 'ToolbarDialogPortalController',
				controllerAs       : 'vm',
				templateUrl        : 'app/toolbar/dialogs/create-portal.html',
				clickOutsideToClose: true
			});
		}

		function openModalProperty(type) {
			$mdDialog.show({
				controller         : 'ToolbarDialogPropertyController',
				controllerAs       : 'vm',
				templateUrl        : 'app/toolbar/dialogs/create-property.html',
				clickOutsideToClose: true
			});
		}
		...
		function updateProfileModal() {
			$mdDialog.show({
				...
				templateUrl        : 'app/toolbar/dialogs/update-profile.html',
				clickOutsideToClose: true
			});
		}
